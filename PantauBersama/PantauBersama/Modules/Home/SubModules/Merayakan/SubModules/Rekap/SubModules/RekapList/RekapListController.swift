...
class RekapListController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel.output.itemsO
            ...
            .drive(tableView.rx.items) { tableView, row, item in
                ...
                cell.configureCell(item: RekapViewCell.Input(data: item, type: RekapType.kota))
                return cell
        }.disposed(by: disposeBag)
