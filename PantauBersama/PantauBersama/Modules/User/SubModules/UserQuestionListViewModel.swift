...
class UserQuestionListViewModel: IQuestionListViewModel, IQuestionListViewModelInput, IQuestionListViewModelOutput{
    ...
    init(navigator: IQuestionNavigator, showTableHeader: Bool, userId: String) {
        self.userId = userId
    ...
    func recursivelyPaginateItems(
        ...
        Observable<Page<[QuestionModel]>> {
            return NetworkService.instance
                .requestObject(
                    TanyaKandidatAPI.getUserQuestion(id: userId, page: batch.page, perPage: batch.limit), c: QuestionsResponse.self)
